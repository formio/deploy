...
module.exports = (program) => {
    program
        ...
        .option('--pdf-server-url [pdfServerUrl]', 'Proxy url for the PDF server')
        ...
        .option('--portal-secret [portalSecret]', 'Remote server secret for portal connection.')
        ...
        .option('--base-url [baseUrl]', 'The root domain for application')
